...
final class Version20240226131115 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE receipt (id INT NOT NULL, contract_id_id INT NOT NULL, external_id VARCHAR(255) NOT NULL, start_application DATE NOT NULL, end_application DATE NOT NULL, due_date DATE NOT NULL, amount_ttc DOUBLE PRECISION NOT NULL, payment_mode VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE, PRIMARY KEY(id))');
