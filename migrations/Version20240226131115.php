...
final class Version20240226131115 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contract (id INT NOT NULL, external_id VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, debit_day INT NOT NULL, effective_date DATE NOT NULL, end_effective_date DATE NOT NULL, annual_prime_ttc DOUBLE PRECISION NOT NULL, debit_mode VARCHAR(255) NOT NULL, recurrence VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE receipt (id INT NOT NULL, contract_id_id INT NOT NULL, external_id VARCHAR(255) NOT NULL, start_application DATE NOT NULL, end_application DATE NOT NULL, due_date DATE NOT NULL, amount_ttc DOUBLE PRECISION NOT NULL, payment_mode VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE transaction (id INT NOT NULL, receipt_id_id INT NOT NULL, transaction_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, payment_date TIMESTAMP(0) WITHOUT TIME ZONE, amount DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, failure_reason VARCHAR(255) DEFAULT NULL, failure_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE, PRIMARY KEY(id))');
